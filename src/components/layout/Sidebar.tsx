...
import { LayoutDashboard, HomeIcon, Wrench, PackageIcon, UsersIcon, LineChartIcon, SettingsIcon, Layout } from "lucide-react";
...
export default function Sidebar({ links }: { links: SidebarProps['links']}) {
